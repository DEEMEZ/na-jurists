    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-[#2c415e] mb-2">News &amp; Alerts</h1>
            <p className="text-[#666b6f]">
              Latest legal news and updates from N&amp;A Jurists
            </p>
          </div>
          ...
          {!loading && !error && items.length === 0 && (
            <div className="bg-white rounded-lg shadow-sm px-6 py-16 text-center">
              ...
              <p className="text-[#666b6f]">No news alerts yet. Check back soon.</p>
            </div>
          )}
