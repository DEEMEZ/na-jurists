    ...
    <div className="w-full overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 lg:py-24">
          ...
          <div className={`max-w-3xl mx-auto text-center transition-all duration-1000 ${
            ...
            <h1 className="mb-4 text-4xl font-bold leading-tight text-[#2c415e] md:text-5xl">
              Reported Judgments & Legal Precedents
              <span className="mt-2 block font-light italic text-[#4a6789]">Landmark Decisions, Legal Insights</span>
            </h1>
            <p className="mx-auto mb-8 max-w-2xl text-base text-[#666b6f]">
              Access our comprehensive collection of reported judgments and legal precedents that shape Pakistani jurisprudence and provide valuable insights into judicial decision-making.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className={`w-full transition-all duration-1000 delay-300 ${
          ...
          <Image
            src={casesHeroImage}
            alt="N&A Jurists Reported Judgments"
            width={1920}
            height={600}
...
export default ReportedJudgmentsHero;